  ...
  return (
    <div className="mt-2 rounded-lg border border-white/10 bg-slate-900/60 p-2.5 max-w-xl">
      <div className="flex items-center justify-between mb-2">
        <span className="text-[11px] text-slate-300">Kies een personage</span>
      ...
      <div className="flex flex-wrap gap-2 max-h-56 overflow-y-auto">
        {metBeeld.map((ch) => (
          <button
            ...
            className="w-20 rounded-lg border border-white/10 bg-slate-900/40 p-1.5 hover:border-orange-400/60 transition text-left"
          >
