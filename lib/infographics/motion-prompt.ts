...
const PRESERVE_RULE =
  "STRICT RULE — do not add, draw, invent, generate or duplicate ANYTHING that is not already in the source image. No new text, letters, words, numbers, labels, captions, charts, graphs, bars, icons, characters or objects. NEVER add a hand, finger, arm, leg or any other body part, and never let a hand or person enter the frame from outside — if a body part is not already fully visible in the source image, it must never appear. Nothing enters the frame from any edge. Above all, do NOT add any decorative elements such as leaves, plants, flowers, clouds, sky, smoke, steam, mist, bubbles, sparkles or floating shapes — if they are not in the source image, they must not appear. Do NOT redraw, restyle, warp or morph any existing text, numbers, chart bars or shapes — keep all of them perfectly still, sharp and identical to the source. Preserve every shape, color, line, position and the exact composition unchanged.";
