...
8. Zet bij elke scene in "cast" de namen van de castleden die erin voorkomen (exact zoals in de castlijst, of een lege lijst als er niemand uit de cast in beeld is). Noem diezelfde personen in de Engelse briefing bij naam én met hun twee meest herkenbare kenmerken, bijvoorbeeld: "JOHAN (the appraiser, mid-40s, short blond hair, grey blazer over a green shirt) shows a report to ...". Zonder die herhaling tekent het beeldmodel elke scene een andere man.
   - HOORT DIT PERSONAGE HIER ECHT? Een verhaal kan van tijd, plaats of wereld wisselen: van het oude Pompeii naar een museum van nu, van een werkplaats naar een klaslokaal. Zet een castlid alleen in een scene als hij daar volgens het verhaal ook is. Speelt de scene in een andere tijd of bij andere mensen, dan is de lijst leeg en beschrijf je in de briefing de mensen die er wél horen ("modern museum visitors in everyday clothes"). Een Romeins gezin in een scene over het heden is de fout die we hiermee voorkomen.
